export const SITE = {
  ...
  description:
    'Find storytimes, music, drop-ins, library events, community programs, and local family activities for ages 0–5 in the Bay Area. Starting in Palo Alto, Los Altos, Mountain View, and Sunnyvale.',
  ogDescription:
