...
export const SEASONAL_COLLECTIONS: SeasonalCollection[] = [
  {
    ...
    driveEventIds: [
      ...
      'seasonal-drive-larpd-applefest-2026-09-13',
      'seasonal-drive-patchen-pumpkin-patch-2026-09-18',
      'seasonal-drive-flood-park-fallfest-2026-09-19',
      'seasonal-drive-hayward-ag-day-meek-2026-09-19',
      'seasonal-drive-santa-clara-art-wine-2026-09-19',
      'seasonal-drive-millbrae-mid-autumn-festival-2026-09-19',
      'seasonal-drive-webb-ranch-pumpkin-patch-2026-09-25',
      'seasonal-drive-pacific-coast-fog-fest-2026-09-26',
...
export const HELLO_FALL_DISCOVERY_PIPELINE: HelloFallCurationCandidate[] = [
  ...
  {
    discoveryId: 'seasonal-drive-larpd-applefest-2026-09-13',
    title: 'Applefest at Ravenswood',
    date: '2026-09-13',
    city: 'Livermore',
    why: 'Worth a drive · cider pressing, orchard, games & apple craft — this Sunday only.',
    priority: 'high',
  },
  {
    discoveryId: 'seasonal-drive-patchen-pumpkin-patch-2026-09-18',
    title: 'Patchen Pumpkin Patch',
    date: '2026-09-18',
    city: 'Los Gatos',
    why: 'Worth a drive · closer calmer patch; opens Fri Sep 18.',
    priority: 'high',
  },
  {
    discoveryId: 'seasonal-drive-hayward-ag-day-meek-2026-09-19',
    title: 'Ag Day at Meek Park',
    date: '2026-09-19',
    city: 'Hayward',
    why: 'Worth a drive · free farm animals & Kids Corn-er next Saturday.',
    priority: 'high',
  },
]
